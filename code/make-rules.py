                ...
                if cell_uni:
                    ...
                    for integer in range(1, size+1):
                        for integer2 in range(integer+1, size+1):
                            clause = []
                            clause.append("-{}".format(289*(row)+17*(column)+integer))
                            clause.append("-{}".format(289*(row)+17*(column)+integer2))
                            rules.append(clause)
                ...
                if row_uni:
                    ...
                    for column in range(1, size+1):
                        for column2 in range(column+1, size+1):
                            clause = []
                            clause.append("-{}".format(289*(row)+17*(column)+integer))
                            clause.append("-{}".format(289*(row)+17*(column2)+integer))
                            rules.append(clause)
                                    ...
                                    for column in range(1, blocks+1):
                                        ...
                                        for row2 in range(start_row, blocks+1):
                                            for column2 in range(start_column, blocks+1):
                                                ...
                                                clause = []
                                                clause.append("-{}".format(289*(row_value)+17*(column_value)+integer))
                                                clause.append("-{}".format(289*(row2_value)+17*(column2_value)+integer))
                                                rules.append(clause)
                                                start_column = 1
